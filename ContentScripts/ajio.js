...
couponArray = [];
let url = "https://www.ajio.com/cart/redeemvoucher?voucherCode=";
let url2 = "https://www.ajio.com/cart/releasevoucher?voucherCode=";
...
if (couponArray.length === 0){
    alert('Donot have a couponcode for you')
}
